    ...
    <PageWrapper>
      <div className={styles.container}>
        ...
        <div className={styles.label}>
          ...
          <Title unSplit label='Gamer' color='white' dotColor='red' />
        </div>
        <p>{t('hello')}</p>
        <div className={styles.socials}>
          <SocialButton src='/img/instagram.svg' link='https://instagram.com/agcakza' alt='Instagram' />
          <SocialButton src='/img/linkedin.svg' link='https://www.linkedin.com/in/avtandil-katsadze-174357213/' alt='LinkedIn' />
